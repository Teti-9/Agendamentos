/*
  ...
  - You are about to drop the column `sobrenome` on the `Agendamento` table. All the data in the column will be lost.
...
INSERT INTO "new_User" ("email", "id", "senha", "telefone") SELECT "email", "id", "senha", "telefone" FROM "User";
DROP TABLE "User";
